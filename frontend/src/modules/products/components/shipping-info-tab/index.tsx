    ...
    <div className="text-small-regular py-8">
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          <FastDelivery />
          <div>
            <span className="text-base font-semibold">快速配送</span>
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            <span className="text-base font-semibold">庫存政策</span>
            <p className="max-w-sm text-sm text-gray-600">
        ...
        {hasBackorderVariants && (
          <div className="flex items-start gap-x-2">
            ...
            <div>
              <span className="text-base font-semibold">預訂商品說明</span>
              <p className="max-w-sm text-sm text-gray-600">
        ...
        <div className="flex items-start gap-x-2">
          <Refresh />
          <div>
            <span className="text-base font-semibold">簡單換貨</span>
            <p className="max-w-sm text-sm text-gray-600">
        ...
        <div className="flex items-start gap-x-2">
          <Back />
          <div>
            <span className="text-base font-semibold">輕鬆退貨</span>
            <p className="max-w-sm text-sm text-gray-600">
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            <span className="text-base font-semibold">特殊注意事項</span>
            <p className="max-w-sm text-sm text-gray-600">
